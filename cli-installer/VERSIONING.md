# 📚 Versioning Guide - design-superskills
...
- **How users access it:** `npm install design-superskills` or `npx design-superskills`

### Main (Git branch)
- **What it is:** Main source code branch on GitHub
- **State:** May be "ahead" of the version published to npm
- **Relationship with npm:** Code on `main` → git tag `v*` → GitHub Actions → npm publish
...
# 6. Wait for publishing (~2 min)
# Check: https://github.com/ericgandrade/design-superskills/actions
```
...
git add .
git commit -m "feat: add 'info' command to display skill details"
...
# 3. Update CHANGELOG with highlighted BREAKING CHANGES
vim CHANGELOG.md
...
### Added
- New `info` command to display skill details
...
[Unreleased]: https://github.com/ericgandrade/design-superskills/compare/v1.1.0...HEAD
[1.1.0]: https://github.com/ericgandrade/design-superskills/compare/v1.0.1...v1.1.0
[1.0.1]: https://github.com/ericgandrade/design-superskills/compare/v1.0.0...v1.0.1
[1.0.0]: https://github.com/ericgandrade/design-superskills/releases/tag/v1.0.0
```
...
# View all versions published to npm
npm view design-superskills versions

# View latest version info
npm view design-superskills

# Test a specific version
npx design-superskills@1.0.1 --version
...
1. Check logs: https://github.com/ericgandrade/design-superskills/actions
2. Common cause: npm token expired (expires every 90 days)
3. Solution: Create new token and update GitHub Secret NPM_TOKEN
...
⚠️ **npm token expires in 90 days** (around **May 2, 2026**)
...
```
Git main branch: design-superskills (source code)
├─ package.json: v1.0.0
├─ git tag: v1.0.0
└─ GitHub Actions: Triggered by v* tag

npm registry: design-superskills
├─ Published version: 1.0.0
├─ Tag: latest
└─ Available: npx design-superskills
```
