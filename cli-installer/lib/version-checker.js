...
/**
 * Checks if design-superskills is already installed on any platform
...
function isUpdateAvailable(installInfo) {
  ...
  for (const installedVersion of Object.values(versions)) {
    ...
    try {
      ...
      // Invalid version, assume update is available
      return true;
    }
  }
...
/**
 * Checks if a specific platform has design-superskills installed
