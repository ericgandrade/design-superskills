...
Automatic workflow that publishes the `design-superskills` package to npm when you create a version tag.
...
1. Create an **Automation Token** on npm:
   ...
   - Token Name: `github-actions-design-superskills`
   - Expiration: No expiration
   - Copy the token (starts with `npm_...`)

2. Add as Secret on GitHub:
   - Go to: https://github.com/ericgandrade/design-superskills/settings/secrets/actions
...
#### 3️⃣ Monitor Publishing

- Go to: https://github.com/ericgandrade/design-superskills/actions
- Watch the "Publish to npm" workflow running
- ✅ When done, package is on npm!
...
- ✅ **No local 2FA**: Token is stored securely on GitHub
...
- Check that the token is of type "Automation"
...
# View at: https://github.com/ericgandrade/design-superskills/actions
```
