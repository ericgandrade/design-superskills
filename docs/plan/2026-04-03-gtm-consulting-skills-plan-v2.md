...
## Session Context (Session State as of 2026-04-03)
...
3. **Arc Assessment → SI → Outsourcing:** possible path, not a forced sequence
4. **Differentiation from abx-strategy:** that skill is for generic B2B; these are for Microsoft consulting
5. **Framework source:** the 21 frameworks are used as ingredients adapted to the Avanade context, not copied verbatim
...
**These fields go in README.md** in the `## Metadata` table.
...
| **Emerging** | >$1M Revenue (expected growth) | DDC (Digital Demand Center) + hybrid BDE |
| **Whitespace** | Net new — sem relacionamento | DDC. Digital first. Hero Offer como entry opcional. |

> **Hero Offer rule:** Hero Offers (fixed-fee, $30–75K, 2–6 weeks) are **recommended entry option for Whitespace and Emerging**, not a mandatory gate. The client can buy SI directly if the context allows. The important thing is to sell.
...
Defines Ideal Customer Profiles (ICPs) for Microsoft consulting engagements. Segments accounts by Avanade operational tiers (MVC, High Growth, Emerging, Whitespace), maps buyer personas by offer type, applies PURE scoring adapted to the professional services context, and produces explicit Anti-ICP to protect win-rate and pipeline quality.
...
2. "Score this account for Outsourcing: High Growth, CMT sector, $2M potential, newly changed CFO, LGPD mandatory"
...
5. "What is the Whitespace account profile that justifies an AI Assessment Hero Offer before proposing SI?"
```
...
**Purpose:** Build GTM strategy for Microsoft platform consulting offers targeting Avanade's account tiers. Produces GTM canvas by offer type with value prop by pillar, entry motion, expansion arc, and win metrics.
...
**Hero Offer rule:** Hero Offer is a recommended entry option for Whitespace/Emerging — not a mandatory gate. The skill presents the Assessment → SI → Outsourcing arc as a possible path, not a forced sequence.
...
2. "Structure the expansion from a Cloud Assessment to $500K SI at Safra — what needs to be true?"
...
5. "Create GTM Canvas for Shared Services at HPS — Advisory pillar, MVC tier, entry already made via Assessment"
```
...
**Purpose:** Pre-sales qualification framework for Microsoft consulting deals. Combines consultative BANT (DDC SAL process) + adapted MEDDPICC + structured go/no-go. Governs pre-sales hours investment and defines kill conditions.
...
- "What is the go/no-go to invest pre-sales in this MVC account?"
- "Our win-rate is low — help review qualification criteria"
- "MEDDPICC completo para esta oportunidade de SI de $800K"
- "Define kill conditions for this deal — we have had 3 months without progress"
...
- Decision Process: purchasing process understood, next steps clear
...
- Identify pattern: where is qualification failing? Pipeline inflated with Tier 3/4?
...
**Purpose:** Consulting pursuit governance — opportunity scorecard, pre-sales investment gates, Continue/Stop decision, and kill signals. Prevent pipeline inflation and bad deals.

**Integrated frameworks:** MEDDPICC (deal scorecard), Strategic Selling (buying influence map, win concession strategy), Conceptual Selling (UFC — Understanding, Fulfill, Commit), JOLT Effect (when the client is paralyzed by risk — when to stop waiting).
...
- "Identify kill signals in this deal — we have had 5 months of stall"
- "How do I structure pursuit governance for opportunities above $500K?"
- "The client is stuck and not deciding — how do I apply JOLT in this situation?"
...
**Purpose:** Generates executive briefings for C-level meetings at Microsoft/Avanade accounts. Executive profile, meeting agenda, discovery questions calibrated by persona, and strategic conversational hooks.
...
**Trigger phrases:**
- "Prepare executive briefing for meeting with Bradesco CIO tomorrow"
...
**Purpose:** Co-selling strategy with Microsoft for Avanade accounts. Maps ATU/STU/CSU roles, assesses co-sell readiness, defines engagement strategy by offer, and identifies access to funding/incentives (MACC, Solution Play funding, FastTrack, ADS).
...
- "Build co-selling strategy with STU for $800K Cloud Migration deal"
...
**Purpose:** Account expansion strategy for existing Avanade accounts. Account diagnosis across 5 dimensions, identification of next expansion bet, 12–24 month roadmap, and account risk register.
...
**Trigger phrases:**
- "Build expansion strategy for Bradesco — we are already SI suppliers"
...
- "Create the 12–24 month expansion roadmap for MVC account in FSI sector"
