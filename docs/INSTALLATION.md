...
```bash
wget -qO- https://raw.githubusercontent.com/ericgandrade/design-superskills/main/scripts/install.sh | bash
```
...
- ✅ Install design-superskills globally via npm
...
```bash
curl -fsSL https://raw.githubusercontent.com/ericgandrade/design-superskills/main/scripts/install.sh | bash -s -- --yes
```

**With options:**
```bash
# Skip Node.js version check
curl -fsSL https://raw.githubusercontent.com/ericgandrade/design-superskills/main/scripts/install.sh | bash -s -- --skip-node-check

# Verbose output
curl -fsSL https://raw.githubusercontent.com/ericgandrade/design-superskills/main/scripts/install.sh | bash -s -- --verbose

# Help
curl -fsSL https://raw.githubusercontent.com/ericgandrade/design-superskills/main/scripts/install.sh | bash -s -- --help
```
...
```bash
git clone https://github.com/ericgandrade/design-superskills.git
cd design-superskills/cli-installer
npm link
```
...
**Unlink:**
```bash
npm unlink -g design-superskills
```
...
- it generates a zip under `~/.design-superskills/plugin-output/`
...
1. Open `Cowork`.
2. Open `Customize`.
3. Find the installed `design-superskills` plugin.
...
### Issue: "design-superskills: command not found" after install
...
bash <(curl -fsSL https://raw.githubusercontent.com/ericgandrade/design-superskills/main/scripts/install.sh)

# Or download and run
curl -fsSL https://raw.githubusercontent.com/ericgandrade/design-superskills/main/scripts/install.sh -o install.sh
chmod +x install.sh
./install.sh
```
...
2. After installing, run `npx design-superskills` again
...
```bash
# Reinstall
npx design-superskills --all -y

# Or use doctor command to diagnose
npx design-superskills doctor
```
...
cd ~/.codex/skills
ln -s /path/to/design-superskills/skills/skill-creator skill-creator
ln -s /path/to/design-superskills/skills/prompt-engineer prompt-engineer
ln -s /path/to/design-superskills/skills/youtube-summarizer youtube-summarizer
ln -s /path/to/design-superskills/skills/audio-transcriber audio-transcriber
```

---
   - **Claude Code:** https://code.claude.ai/
   
2. Run `design-superskills` again - it will detect the tools
...
**Remove npm package:**
```bash
npm uninstall -g design-superskills
```
...
```bash
npm update -g design-superskills
```
...
- **GitHub Repository:** https://github.com/ericgandrade/design-superskills
- **NPM Package:** https://npmjs.com/package/design-superskills
- **Issues:** https://github.com/ericgandrade/design-superskills/issues
- **Changelog:** https://github.com/ericgandrade/design-superskills/blob/main/cli-installer/CHANGELOG.md
...
1. Check existing issues: https://github.com/ericgandrade/design-superskills/issues
